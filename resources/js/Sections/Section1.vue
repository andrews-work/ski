<template>
    <div class="bg-white">
    <div class="relative px-6 bg-purple-100 isolate pt-14 lg:px-8">
      ...
      <div class="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-5xl font-semibold tracking-tight text-gray-900 text-balance sm:text-7xl">Data to enrich your online business</h1>
