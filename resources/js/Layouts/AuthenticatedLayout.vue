        ...
        <nav class="bg-white border-b border-gray-100 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown, }" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink :href="route('news-feeds')" :active="route().current('news-feeds')">
                        News Feeds
                    </ResponsiveNavLink>

                    <ResponsiveNavLink :href="route('meetings.index')" :active="route().current('meetings.index')">
                        Meetings
                    </ResponsiveNavLink>

                    <ResponsiveNavLink :href="route('timesheets')" :active="route().current('timesheets')">
                        Timesheets
                    </ResponsiveNavLink>
